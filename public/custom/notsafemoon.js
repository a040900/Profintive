var launch_date=new Date(2021,5,20,0,0,0,0);var number_anim_duration=1000;var token_data_timout=10000;function copyAddressToClipboard(){var $temp=$("<input>");$("body").append($temp);$temp.val($("#nsm-token-address").text()).select();document.execCommand("copy");$temp.remove();}
